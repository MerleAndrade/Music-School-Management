...
export default function AllRoutes() {
    ...
    return (
        <>
            <Routes>
                <Route path={"/"}
                       element={<Home addTeacher={teacherHook.addTeacher} addStudent={addStudent}
                                      instruments={instruments}
                                      getAllTeachers={teacherHook.getAllTeachers} addInstruments={addInstruments}
                                      firstNameTeachers={firstNameTeachers} firstNameStudents={firstNameStudents}/>}/>
                <Route path={"/students"}
                ...
                <Route path={"/teachers"}
                       element={<TeacherDetails teachers={teacherHook.teachers} editTeacher={teacherHook.editTeacher}
