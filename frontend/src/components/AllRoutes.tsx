...
export default function AllRoutes () {
    ...
    return(
        <>
            <Routes>
                <Route path ={"/"}
                       element={<Home addTeacher={addTeacher} addStudent={addStudent} instruments={instruments} addCourse={addCourse}/>}/>
                <Route path = {"/teachers"}
                ...
                <Route path = {"/courses"}
                       element = {<CourseGallery  addCourse={addCourse} instruments={instruments}/>}/>
